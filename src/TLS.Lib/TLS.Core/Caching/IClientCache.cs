...
namespace AEC.Core.Caching
{
    public interface IClientCache : IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// Return the instance of <see cref="ICacheSerializer"/>
        /// </summary>
        ICacheSerializer Serializer { get; }
        ...
        T Get<T>(string key, Func<T> getFunc) where T : class;
        T Get<T>(string key, Func<T> getFunc, DateTimeOffset expiresAt) where T : class;
        T Get<T>(string key, Func<T> getFunc, TimeSpan expiresIn) where T : class;
        ...
        Task<T> GetAsync<T>(string key, Func<T> getFunc) where T : class;
        Task<T> GetAsync<T>(string key, Func<T> getFunc, DateTimeOffset expiresAt) where T : class;
        Task<T> GetAsync<T>(string key, Func<T> getFunc, TimeSpan expiresIn) where T : class;
